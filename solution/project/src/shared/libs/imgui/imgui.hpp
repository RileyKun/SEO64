...
namespace ImGui
{
    ...
    IMGUI_API bool          SelectableWithValueOnRight(const char *label, bool selected, const char *value, ImGuiSelectableFlags flags = 0, const ImVec2 &size_arg = ImVec2(0, 0));
